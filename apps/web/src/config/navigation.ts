...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Quotations', href: '/quotations', icon: FileText, roles: ['SUPER_ADMIN', 'ADMIN'], module: 'CRM', isPrimaryMobile: true },
  { label: 'Revenue Overview', href: '/revenue', icon: DollarSign, roles: ['SUPER_ADMIN'], module: 'REVENUE', isPrimaryMobile: true },
  { label: 'Per-Project P&L', href: '/revenue/pnl', icon: ChartNoAxesCombined, roles: ['SUPER_ADMIN'], module: 'REVENUE' },
  { label: 'Contracts', href: '/contracts', icon: FileCheck, roles: ['SUPER_ADMIN'], module: 'REVENUE', isPrimaryMobile: true },
  { label: 'Invoice Drafts', href: '/invoice-drafts', icon: FilePen, roles: ['SUPER_ADMIN'], module: 'REVENUE' },
  { label: 'Payments', href: '/payments', icon: Banknote, roles: ['SUPER_ADMIN'], module: 'REVENUE', isPrimaryMobile: true },
  { label: 'Subscriptions', href: '/subscriptions', icon: CalendarDays, roles: ['SUPER_ADMIN'], module: 'REVENUE' },
  { label: 'Receivables', href: '/receivables', icon: Wallet, roles: ['SUPER_ADMIN'], module: 'REVENUE', isPrimaryMobile: true },

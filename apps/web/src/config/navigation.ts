...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Contracts', href: '/contracts', icon: FileCheck, roles: ['SUPER_ADMIN'], module: 'REVENUE' },
  { label: 'Invoice Drafts', href: '/invoice-drafts', icon: FilePen, roles: ['SUPER_ADMIN'], module: 'REVENUE' },
  { label: 'Payments', href: '/payments', icon: Banknote, roles: ['SUPER_ADMIN'], module: 'REVENUE' },

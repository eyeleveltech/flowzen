...
export function ApiKeysTab() {
  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      {newKey && (
        <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-4 sm:p-5 max-w-xl space-y-3">
          ...
          <div className="flex items-center gap-2 bg-white border border-emerald-100 rounded-xl p-2.5 min-w-0">

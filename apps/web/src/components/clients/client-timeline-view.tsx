          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar">
            {clients.map((client) => (
              <Link
                ...
                className="h-16 px-4 flex items-center border-b border-[#F3F4F6] hover:bg-white transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm"
              >

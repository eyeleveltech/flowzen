            ...
            <div className="rounded-2xl border border-border bg-white p-6">
              <div className="space-y-3">
                {projects.filter((p) => p.startDate && p.endDate).map((p) => {
                  ...
                  return (
                    <div key={p.id} className="flex flex-col md:flex-row md:items-center gap-3 md:gap-4 py-3 md:py-2 cursor-pointer hover:bg-surface rounded-xl px-3 -mx-3 transition-colors border-b border-subtle last:border-0 md:border-0" onClick={() => router.push(`/projects/${p.id}`)}>

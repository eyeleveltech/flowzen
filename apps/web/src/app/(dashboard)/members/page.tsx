            ...
            >
              ...
              <div className={`p-5 rounded-2xl border transition-colors ${isOverloaded ? 'bg-red-50/30 border-red-100' : 'bg-surface border-border/80'}`}>
                ...
                <div className="h-2 w-full rounded-full bg-border overflow-hidden">
                  <div
                    className={`h-full rounded-full transition-all duration-500 ease-out motion-reduce:transition-none ${isOverloaded ? 'bg-red-500' : stats.capacity > 80 ? 'bg-red-500' : stats.capacity > 50 ? 'bg-amber-500' : 'bg-green-500'
                      }`}

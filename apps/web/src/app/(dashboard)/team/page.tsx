    ...
    <div className="max-w-350 mx-auto p-4 md:p-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 w-full space-y-6">
          {/* Controls Bar */}
          <div className="flex flex-col sm:flex-row gap-4 bg-surface p-4 rounded-2xl border border-border/80">
            {/* Search Input */}
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 text-sm bg-white rounded-xl border border-border outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
              />
            </div>

...
- Name: teams.spec.ts >> Team & Department Flow >> User can delete a department
- Location: tests\teams.spec.ts:61:7
...
Call log:
  - waiting for locator('input[placeholder="Your company name"]')
